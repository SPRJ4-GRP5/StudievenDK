...
namespace StudievenDK.Controllers
{
    public class CasesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["CourseName_fk"] = new SelectList(_context.Courses, "CourseName", "CourseName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CaseId,Text,Subject,UserHelper_fk,UserSeeker_fk,PictureName")] Case @case)
        {
            ...
            ViewData["CourseName_fk"] = new SelectList(_context.Courses, "CourseName", "CourseName", @case.CourseName_fk);
            return View(@case);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CaseId,Text,Subject,UserHelper_fk,UserSeeker_fk,PictureName")] Case @case)
        {
            if (id != @case.CaseId)
            {
                return NotFound();
